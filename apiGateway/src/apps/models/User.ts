...
const findUserHobbyById = async (id: string) => await User.findOne({ _id: id }).populate('hobbies');
...
export { User, findUserByName, findUserHobbyById, findUsersHobbies, removeUser, updateUser };